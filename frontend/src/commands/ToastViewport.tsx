      ...
      <Show when={props.toast.action}>
        {(action) => (
          <button
            ...
            class="shrink-0 px-1.5 py-0.5 rounded border border-border text-[11px] text-muted-foreground hover:text-foreground hover:bg-accent/40 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
          >
            {action().label}
          </button>
        )}
