...
fn render_template(content: &str, variables: &HashMap<String, String>) -> String {
    ...
    for (name, value) in variables {
        ...
        // Also support {{name:default}} syntax
    ...
    // Fill remaining {{name:default}} with their defaults
...
#[tauri::command]
pub fn prompt_list(
    state: tauri::State<'_, PromptStudioState>,
...
pub fn prompt_execute(
    ...
    state: tauri::State<'_, PromptStudioState>,
    migration_state: tauri::State<'_, MigrationState>,
