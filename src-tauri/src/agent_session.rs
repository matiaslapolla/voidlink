...
use voidlink_core::git::git_create_worktree_impl;
use voidlink_core::git::CreateWorktreeInput;
use voidlink_core::agent_runner::{AgentSessionInfo, AgentStatus, ScrollbackStore, StartSessionInput};

use crate::{PtyChannels, PtySession, PtyStore};
...
pub(crate) fn cleanup_session(
    ...
    voidlink_core::git::git_remove_worktree_impl(repo_path, worktree_name, true)
}
