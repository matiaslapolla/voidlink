...
pub const DETERMINISTIC_EMBED_MODEL: &str = "deterministic-v1";
...
pub fn chunk_content(content: &str, max_lines: usize, overlap: usize) -> Vec<ChunkRecord> {
...
pub fn truncate_plain(content: &str, max_chars: usize) -> String {
...
pub fn deterministic_embedding(content: &str, size: usize) -> Vec<f32> {
...
pub fn jaccard_similarity(left: &[String], right: &[String]) -> f32 {
