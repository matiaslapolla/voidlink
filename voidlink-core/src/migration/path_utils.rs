...
pub const APP_IGNORE_DIRS: [&str; 9] = [
    ".git",
    "node_modules",
    "target",
    "dist",
...
pub fn first_env_or_default(names: &[&str], default: &str) -> String {
...
pub fn canonicalize_repo_path(input: &str) -> Result<String, String> {
...
pub fn should_ignore_app_path(path: &Path, root: &Path) -> bool {
...
pub fn split_relative_path(input: &str) -> Vec<String> {
...
pub fn parent_rel_path(path: &str) -> String {
...
pub fn join_relative(base: &str, suffix: &str) -> String {
